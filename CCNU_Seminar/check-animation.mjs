// Run after the production build, with CCNU_PREVIEW_URL pointing to its served base.
// Example: CCNU_PREVIEW_URL=http://127.0.0.1:4174/EveNet-Presentation/CCNU_Seminar/ node CCNU_Seminar/check-animation.mjs
import { chromium } from 'playwright-chromium'
import assert from 'node:assert/strict'
import { mkdir } from 'node:fs/promises'
const base = process.env.CCNU_PREVIEW_URL
assert(base, 'Set CCNU_PREVIEW_URL to the locally served CCNU production base')
