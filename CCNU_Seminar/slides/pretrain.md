...
# <span class="evenet-wordmark gradient-animated">EveNet</span> pretraining variants
...
<div class="mt-6 h-full w-full">
  <div class="grid gap-6 items-stretch w-full" style="grid-template-columns: 1fr 1fr; grid-gap: 1.5rem;">
    ...
    <!-- Right Column: Training Variants Card -->
    <div class="rounded-lg border-2 border-indigo-800 bg-indigo-800/15 p-4 flex flex-col h-full">
      <h2 class="font-bold mb-2 flex items-center" style="font-size: 28px; line-height: 1.15;">
        <div i-carbon:model class="text-teal-300 mr-2 text-xl" />
        Hybrid Training &amp; Ablation
      </h2>
      <div class="flex flex-col gap-2 flex-1">
        <!-- Stage 1: Self-Supervised -->
        <div class="rounded-lg border-2 border-teal-800 bg-teal-800/15 p-2">
          <div bg="teal-800/30" px-2 py-0.5 flex items-center justify-between text-xs mb-1 rounded>
            <div class="flex items-center">
              <div i-carbon:settings class="text-teal-300 mr-2" />
              <span font-bold>Stage 1: Self-Supervised</span>
            </div>
            <span class="evenet-wordmark gradient-animated" style="font-variant: small-caps;">EveNet-SSL</span>
          </div>
          <div class="text-xs text-white/80 space-y-1">
            <!-- Active Head Highlight -->
            <div class="flex flex-wrap gap-2 mb-1">
              <div class="rounded-lg border-2 border-teal-400 bg-teal-800/30 px-2 py-1 flex items-center gap-1.5">
            ...
            <div class="flex items-start gap-2">
              ...
              <span>Learns underlying point cloud representation</span>
            </div>
            <div class="flex items-start gap-2">
              <div i-carbon:chart-line class="text-teal-300 mt-0.5 shrink-0" />
              <span>
                <span class="font-semibold text-teal-200">Masking:</span> 10% → 100%
              </span>
            </div>
          </div>
        </div>
        ...
        <div class="rounded-lg border-2 border-indigo-800 bg-indigo-800/15 p-2">
          <div bg="indigo-800/30" px-2 py-0.5 flex items-center justify-between text-xs mb-1 rounded>
            <div class="flex items-center">
              <div i-carbon:settings class="text-indigo-300 mr-2" />
              <span font-bold>Stage 2: Full Training</span>
            </div>
            <span class="evenet-wordmark gradient-animated" style="font-variant: small-caps;">EveNet-Full</span>
          </div>
          <div class="text-xs text-white/80 space-y-1">
            <!-- Active Heads Highlight -->
            <div class="flex flex-wrap gap-2 mb-1">
              <div class="rounded-lg border-2 border-sky-400 bg-sky-800/30 px-2 py-1 flex items-center gap-1.5">
              ...
              <div class="rounded-lg border-2 border-indigo-400 bg-indigo-800/30 px-2 py-1 flex items-center gap-1.5">
            ...
            <div class="flex items-start gap-2">
              ...
              <span>Multi-task optimization; assignment head off</span>
            </div>
            <div class="flex items-start gap-2">
        ...
        <!-- EveNet-Cls: Classification-Only Ablation -->
        <div class="rounded-lg border-2 border-fuchsia-700/80 bg-fuchsia-950/20 p-2">
          <div bg="fuchsia-900/25" px-2 py-0.5 flex items-center justify-between text-xs mb-1 rounded>
            <div class="flex items-center">
              <div i-carbon:flask class="text-fuchsia-300 mr-2" />
              <span font-bold>Ablation: One-Stage CLS</span>
            </div>
            <span class="evenet-wordmark font-semibold gradient-animated" style="font-variant: small-caps;">EveNet-Cls</span>
          </div>
          <div class="text-xs text-white/80 space-y-1">
            <div class="flex flex-wrap gap-2 mb-1">
              <div class="rounded-lg border-2 border-sky-400 bg-sky-800/30 px-2 py-1 flex items-center gap-1.5">
                <div i-carbon:chart-bar class="text-sky-300 text-sm" />
                <span class="font-bold text-sky-100">CLS only</span>
              </div>
              <div class="rounded-lg border border-fuchsia-500/60 bg-fuchsia-900/20 px-2 py-1 flex items-center gap-1.5">
                <div i-carbon:layers class="text-fuchsia-300 text-sm" />
                <span class="font-semibold text-fuchsia-100">Same corpus + backbone</span>
              </div>
            </div>
            <div class="flex items-start gap-2">
              <div i-carbon:checkmark-outline class="text-fuchsia-300 mt-0.5 shrink-0" />
              <span>Multiclass process classification throughout pretraining</span>
            </div>
            <div class="flex items-start gap-2">
              <div i-carbon:subtract class="text-fuchsia-300 mt-0.5 shrink-0" />
              <span>CLS-only baseline for public event-level pretrained models</span>
            </div>
          </div>
        </div>
      </div>
