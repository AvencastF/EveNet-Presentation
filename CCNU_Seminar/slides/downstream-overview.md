...
# <span class="evenet-wordmark gradient-animated">EveNet</span> Downstream Tasks Overview
            ...
            <div class="space-y-0.5 result-bars-container">
              ...
              <div class="result-row">
                <div class="result-name result-name-ssl">
                  <span style="font-variant: small-caps;">SSL</span>
                </div>
                <div class="result-bar-container">
              ...
              <div class="result-row">
                <div class="result-name result-name-full">
                  <span style="font-variant: small-caps;">Full</span>
                </div>
                <div class="result-bar-container">
      ...
      <div class="pt-2 border-t border-white/10 h-illustration">
        <div v-click="1" class="h-full flex flex-col justify-start gap-1 result-card-reveal">
          ...
          <div class="grid-improvement-rows">
            ...
            <div class="grid-improvement-row">
              <span class="grid-improvement-name result-name-ssl"><span style="font-variant: small-caps;">SSL</span></span>
            ...
            <div class="grid-improvement-row">
              <span class="grid-improvement-name result-name-full"><span style="font-variant: small-caps;">Full</span></span>
