...
<div class="dp-subtitle">Missing neutrinos prevent direct reconstruction of the tau rest frames; infer the parent motion first.</div>
...
<div class="dp-gloss">In the plots, <LaTeX formula="A,B" /> label the two particles; <LaTeX formula="k,n,r" /> label three spin axes. <LaTeX formula="\theta" /> is the angle between the decay-product direction and a spin axis.</div>
